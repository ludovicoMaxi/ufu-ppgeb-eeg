...
public class Contact {
    ...
    @Id
    @SequenceGenerator( name = "CONTACT_SQ", sequenceName = "CONTACT_SQ", allocationSize = 1 )
    @GeneratedValue( generator = "CONTACT_SQ", strategy = GenerationType.SEQUENCE )
    private Long id;
    ...
    public int hashCode() {
        ...
        return Objects.hash( id, name, active, objectId, objectType, phone, cellphone, whatsapp, facebook, instagram, email, main );
    }
