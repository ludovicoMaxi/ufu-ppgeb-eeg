...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity< ApiError > handleMissingResource( NoResourceFoundException ex ) {
        ...
        return ResponseEntity.status( HttpStatus.NOT_FOUND ).body( ApiError.of( HttpStatus.NOT_FOUND, "Recurso não encontrado." ) );
    }
    ...
    public ResponseEntity< ApiError > handleUnreadableMessage( HttpMessageNotReadableException ex ) {
        ...
        return ResponseEntity.badRequest().body( ApiError.of( HttpStatus.BAD_REQUEST, "Corpo da requisição inválido." ) );
    }
    ...
    public ResponseEntity< ApiError > handleDataIntegrity( DataIntegrityViolationException ex ) {
        ...
        return ResponseEntity.status( HttpStatus.CONFLICT ).body( ApiError.of( HttpStatus.CONFLICT, "Registro conflitante ou referenciado por outro cadastro." ) );
    }
